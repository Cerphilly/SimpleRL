...
class DQN:
    def __init__(self, state_dim, action_dim, save, load, batch_size=100, gamma=0.99, learning_rate=0.001, epsilon=0.2, training_start=200, copy_iter=1):
    ...
    def train(self, s, a, r, ns, d):
        ...
        with tf.GradientTape() as tape:
            selected_values = tf.math.reduce_sum(self.network(s)*tf.squeeze(tf.one_hot(tf.dtypes.cast(a, tf.int32), action_dim), axis=1), axis=1, keepdims=True)
