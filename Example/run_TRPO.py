...
def trpo_configurations(parser):
    parser.set_defaults(domain_type ='gym')
    parser.set_defaults(env_name ='Acrobot-v1')
    ...
    parser.set_defaults(actor_lr = 0.0003)
    parser.set_defaults(critic_lr = 0.0003)
...
if __name__ == '__main__':
    ...
    parser = TRPO.get_config(parser)
    parser = trpo_configurations(parser)
