...
class DDPG:
    def __init__(self, state_dim, action_dim, max_action, min_action, save, load, actor = None, target_actor = None, critic = None, target_critic=None, batch_size=100, buffer_size=1e6, gamma=0.99, tau = 0.005, actor_lr=0.001, critic_lr=0.001, training_start=500):
        self.actor = actor
