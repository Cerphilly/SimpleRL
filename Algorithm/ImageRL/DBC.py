...
class DBC_SACv2:
    def __init__(self, obs_dim, action_dim, args):
        ...
        self.dynamics_model = Transition_Network(feature_dim=self.feature_dim, action_dim=action_dim, deterministic=False)
        self.reward_model = Reward_Network(feature_dim=self.feature_dim)
        ...
        self.network_list = {'Actor': self.actor, 'Critic1': self.critic1, 'Critic2': self.critic2,
                             ...
                             'Target_Encoder': self.target_encoder, 'Dynamics': self.dynamics_model, 'Reward': self.reward_model}
    ...
    def train(self, training_num):
        ...
        return {'Loss': {'Actor': total_a_loss, 'Critic1': total_c1_loss, 'Critic2': total_c2_loss, 'Alpha': total_alpha_loss,
                         'Encoder': total_encoder_loss, 'Dynamics': total_dynamics_loss, 'Reward': total_reward_loss},
